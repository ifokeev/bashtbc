...
$_bash       = $db->queryArrayRow("SELECT * FROM bash_approved WHERE DATE_SUB(CURDATE(),INTERVAL 1 DAY) <= bash_date_post AND bash_razdel = 'index' ORDER BY bash_rating DESC LIMIT 0, 10");
$_bash_ned   = $db->queryArrayRow("SELECT * FROM bash_approved WHERE DATE_SUB(CURDATE(),INTERVAL 7 DAY) <= bash_date_post AND bash_razdel = 'index' ORDER BY bash_rating DESC LIMIT 0, 10");
$_bash_mes   = $db->queryArrayRow("SELECT * FROM bash_approved WHERE DATE_SUB(CURDATE(),INTERVAL 30 DAY) <= bash_date_post AND bash_razdel = 'index' ORDER BY bash_rating DESC LIMIT 0, 10");
            	...
            	<div class="number_box">
                    <div class="number_box1">
                        <div class="number_box2">
                           <div class="numb_link"><a href="/q/<?=$bash[0];?>"><?=$bash[0];?></a></div>
...
<? else: ?>
            <div class="text_box">
             <center> Нет лучших цитат за день. </center>
            </div>
<? endif; ?>

           <div class="stat_box4">
             <h1>Лучшие цитаты недели</h1>
           </div>


<? if(!empty($_bash_ned)): ?>
<? foreach($_bash_ned as $bash): ?>
            <div class="text_box">
            	<div class="number_box">
                    <div class="number_box1">
                        <div class="number_box2">
...
<? else: ?>
            <div class="text_box">
             <center> Нет лучших цитат за неделю. </center>
            </div>
<? endif; ?>

           <div class="stat_box4">
             <h1>Лучшие цитаты месяца</h1>
           </div>


<? if(!empty($_bash_mes)): ?>
<? foreach($_bash_mes as $bash): ?>
            <div class="text_box">
            	<div class="number_box">
                    <div class="number_box1">
                        <div class="number_box2">
...
<? else: ?>
            <div class="text_box">
             <center> Нет лучших цитат за месяц. </center>
            </div>
<? endif; ?>
