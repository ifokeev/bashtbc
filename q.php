...
$_id         = (empty($_GET['id']) ? header('Location: /') : intval($_GET['id']));
$_bash       = $db->queryArrayRow("SELECT * FROM bash_approved WHERE bash_razdel = 'index' AND bash_app_id = '$_id' ORDER BY bash_date_post DESC LIMIT 50");
...
<? else: ?>
            <div class="text_box">
             <center> Такой цитаты не найдено. </center>
            </div>
<? endif; ?>
